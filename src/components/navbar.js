    ...
    <div className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:hidden">
          ...
          >
            <span className="sr-only font-roboto">Abrir menu</span>
            <Bars3Icon className="h-6 w-6" aria-hidden="true" />
          </button>
        </div>
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-md font-semibold leading-6 text-gray-900 font-medium outline-none	">
              Información
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 font-roboto mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
          ...
          <a href="/arbol" className="text-md font-medium leading-6 text-gray-900 font-roboto">
            Arbol peronista
          </a>
        </Popover.Group>
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="https://chat.whatsapp.com/DBS17Xx8SUVKN04Fu4wfl8" className="text-md font-medium leading-6 text-gray-900">
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="mx-3">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base  leading-7 text-gray-900 hover:bg-gray-50 text-md font-medium">
                        Información
                        <ChevronDownIcon

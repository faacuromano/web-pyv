    ...
    <main className="h-full flex min-h-screen flex-col items-center justify-between px-4">
      ...
      <div className="mb-32 grid text-center lg:max-w-6xl lg:w-full md:grid-cols-2 lg:grid-cols-4 gap-6 lg:text-left mx-auto">
        ...
        <a
          ...
          className="group flex flex-col items-center bg-gray-700 border border-transparent rounded-lg px-5 py-4 transition hover:border-gray-300 hover:bg-gray-100"
          target="_blank"
          rel="noopener noreferrer"
        >
          <h2 className="group-hover:text-cyan-800 text-white mb-3 text-2xl font-medium">
            Afiliate 
          </h2>
        ...
        <a
          ...
          className="group flex flex-col justify-between items-center border border-transparent rounded-lg px-5 py-4 transition hover:border-gray-300 hover:bg-gray-100"
          target="_blank"
          rel="noopener noreferrer"
        >
          <h2 className="text-2xl font-medium group-hover:text-cyan-800">
            Biblioteca 
          </h2>
        ...
        >
          ...
          <p className="text-sm opacity-50 justify-between group-hover:opacity-100">
          Explora las ramas del movimiento  en un árbol interactivo para conocer  sobre el partido y su organización.          </p>
        </a>
        ...
        >
          ...
          <p className="text-sm opacity-50 group-hover:opacity-100">
          Súmate a ayudar al pueblo mediante la olla popular que se realiza en Rosario todos los jueves en plaza Sarmiento.
          </p>
        </a>
      </div>
    </main>

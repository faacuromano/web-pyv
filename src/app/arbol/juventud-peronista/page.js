        ...
        <div className="max-w-4xl mx-auto">
          <div className="max-w-3xl mb-12">
            <p className="font-body text-dark-600 text-base md:text-lg leading-relaxed">
              Tenemos por finalidad la formación de cuadros políticos; colaborar en la
              construcción del partido desde nuestro espacio y nuestra mirada; organizar
              la juventud.
            </p>
            <p className="font-body text-dark-600 text-base md:text-lg leading-relaxed mt-4">
              Queremos que este sea un espacio de construcción, compañerismo, organización
              y acción para todas y todos los jóvenes que sientan al movimiento peronista
              y quieran empezar a militar.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {images.map((img, index) => (
              <div key={index} className="group relative aspect-[4/3] overflow-hidden">
                <Image
                  src={img}
                  alt={`Juventud Peronista - Actividad ${index + 1}`}
                  fill
